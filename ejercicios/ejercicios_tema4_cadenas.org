...
int main()
{
  ...
  printf("El tamanho de la cadena es %d caracteres\n", contador);
  printf("El tamanho de la cadena es %d caracteres", strlen(cadena));
...
int main() 
{
    ...
    printf("La palabra '%s' fue recompuesta después de %d ciclos.\n", palabra, ciclos);
...
int main() 
{
  ...
  while (nombres[i] != '\0') 
  {
    ...
    {
      encontrado = 1;
      printf("El nombre '%s' se encontro en la posicion %d de la lista.\n", nombreBuscado, posicion);
      i++;
    }
...
int main()
{
  ...
  {
    printf("Si lo he encontrado en la posicion %d.", posicion);
  }
  else
  {
