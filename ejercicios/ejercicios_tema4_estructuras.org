...
int main()
{
  ...
  printf("El punto 1 está en el cuadrante %d.\n", cuadrante);
  ...
  printf("El punto 2 está en el cuadrante %d.\n", cuadrante);
...
int main()
{
  ...
  for (i = 0; i < 2; i++)
  {
    ...
    scanf("%d/%d/%d", &contactos[i].fechaNac.d, &contactos[i].fechaNac.m, &contactos[i].fechaNac.a);
  }
...
int main(void)
{
  ...
  if (cuenta_caracteres > 0)
  {
    analisis.media = analisis.media / cuenta_caracteres;  
  }
  
  printf("\n Num vocales: %d", analisis.num_vocal);  
  printf("\n Num contantes: %d", analisis.num_cons);  
  printf("\n Num otros caracteres: %d", analisis.num_carac_esp);  
...
int main () 
{
  ...
  for(i=0; i<N; i++)
  {
    printf("\nIntroduzca los datos del empleado numero %d.", i+1);
    printf("\nNombre: \n");
    scanf("%s", personal[i].nombre);
    printf("\nSalario anual: \n");
    scanf("%d", &personal[i].salario);
    printf("\nHoras por semana: \n");
