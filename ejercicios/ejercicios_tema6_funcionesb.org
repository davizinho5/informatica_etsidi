...
int main() 
{
    ...
    do {
        ...
        {
            printf("Numero de sustituciones realizadas: %d\n", numSustituciones);
        } 
        else 
        {
...
int modificaT(char texto[]) 
{
    ...
    printf("Introduce una frase (max %d caracteres): ", MAX_FRASE - 1);
    scanf("%99[^\n]s", frase);
...
void generaInventario(INV inventario[], int numero_items) 
{
    ...
    {
        printf("Introduce los datos del producto %d\n", i + 1);
...
float calculaInmovilizado(INV producto) 
{
    ...
    {
        printf("El producto con código %s necesita ser pedido. Stock actual: %d\n", producto.cod, producto.stock);
    }
